...
- `query_params` override — point the listing poll at a specific Mostaql filter URL (category, sort, budget, etc.) going forward only, non-retroactive. See [configuration-reference.md](../../v1/product/configuration-reference.md#query_params)
...
Details: [configuration-reference.md](../../v1/product/configuration-reference.md), [search-and-filtering.md](../../v2/product/search-and-filtering.md), [ui-ux-design.md](../../v1/product/ui-ux-design.md).

## v3 scope

A mobile companion app, LAN-based pairing and two-way sync, and push notifications for when the mobile app is fully closed. This is explicitly deferred — it requires a second full application and, for the push sub-feature, a small dependency on FCM/APNs. See [roadmap-future.md](../../v2/product/roadmap-future.md).
